...
module KinnexusTestKit
  module KinnexusV001
    class AllergyIntoleranceClinicalStatusSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for AllergyIntolerance search by clinical-status'
      description %(
...
[Kinnexus Server CapabilityStatement](https://kinnexus.org/CapabilityStatement/kinnexus-responder)
      ...
      id :kinnexus_v001_allergy_intolerance_clinical_status_search_test
