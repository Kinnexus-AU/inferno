...
module KinnexusTestKit
  module KinnexusV001
    class RelatedPersonGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the Kinnexus RelatedPerson.'
      description %(
  # Background

The Kinnexus RelatedPerson sequence verifies that the system under test is
able to provide correct responses for RelatedPerson queries. These queries
must contain resources conforming to the Kinnexus RelatedPerson as
...
the [Kinnexus RelatedPerson](https://kinnexus.org/StructureDefinition/KinnexusRelatedPerson). Each element is checked against
...
read succeeds.
      ...
      id :kinnexus_v001_related_person
      run_as_group
      ...
      test from: :kinnexus_v001_related_person_patient_search_test
      test from: :kinnexus_v001_related_person_read_test
      test from: :kinnexus_v001_related_person_validation_test
      test from: :kinnexus_v001_related_person_must_support_test
      test from: :kinnexus_v001_related_person_reference_resolution_test
    end
  end
end
