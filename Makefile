...
inferno = run inferno
rm_generated = rm -rf lib/kinnexus_test_kit/generated/
ber_generate = bundle exec rake kinnexus_test_kit:generate
lint_generated = rubocop -A lib/kinnexus_test_kit/
...
clean_generated:
	sudo $(rm_generated)
	git checkout lib/kinnexus_test_kit/generated/
